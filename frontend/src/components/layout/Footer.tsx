        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/workouts" className="text-gray-600 hover:text-blue-600 text-sm transition-colors">
                  Workouts
                </a>
              </li>
              <li>
                <a href="/schedule" className="text-gray-600 hover:text-blue-600 text-sm transition-colors">
                  Schedule
                </a>
              </li>
              <li>
                <a href="/stats" className="text-gray-600 hover:text-blue-600 text-sm transition-colors">
                  Statistics
                </a>
              </li>
            </ul>
